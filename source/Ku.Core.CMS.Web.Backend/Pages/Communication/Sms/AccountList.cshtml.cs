...
namespace Ku.Core.CMS.Web.Backend.Pages.Communication.Sms
{
    ...
    public class AccountListModel : BasePage
    {
        private readonly ISmsAccountService _service;

        public AccountListModel(ISmsAccountService service)
        {
        ...
        /// </summary>
        [Auth("view")]
        public async Task<IActionResult> OnPostDataAsync(int page, int rows, SmsAccountSearch where)
        {
