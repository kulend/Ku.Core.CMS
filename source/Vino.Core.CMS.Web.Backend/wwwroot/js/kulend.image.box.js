(function ($) {
    var getEmptyBox = function () {
        ...
        $li.html('<div class="pic-box"><a class="img" href="javascript:;"><img src="/admin/images/empty_photo.jpg" align="absmiddle" /></a><div class="pic-remove" style="display: none;">删除</div></div><a class="link-btn"  href="javascript:;">添加图片</a>');
        return $li;
    }
    ...
    var addItem = function ($element, file) {
        ...
        $addObj.attr("data-thumb", file.thumb_path);
        if (file.thumb_url) {
            $addObj.find("img").attr("src", file.thumb_url);
        } else {
            $addObj.find("img").attr("src", file_path + file.thumb_path);
        }
        $empty.before($addObj);
    ...
    var loadItem = function ($element, data) {
        ...
        if (data.thumb) {
            ...
            $addObj.find("img").attr("src", file_path + data.thumb);
        }
    ...
    var bindButton = function ($element) {
        $element.find(".link-btn").click(function () {
            ...
            parent.OpenWindow("图片选择", "/admin/storage/image/SelectImageDialog.htm", {
                ...
                onSubmit: function (files) {
                    ...
                    if (notAdd) {
                        ...
                        $li.attr("data-thumb", file.thumb_path);
                        $imgItem.attr("src", file.thumb_url);
                    } else {
                        //添加
    ...
    $.fn.kuImageBox = function (options, param) {
        if (typeof options == 'string') {
            return $.fn.kuImageBox.methods[options](this, param);
        }
        options = options || {};
        return this.each(function () {
            ...
            if (opts) {
                ...
                opts = $.extend({}, $.fn.kuImageBox.defaults, options);
