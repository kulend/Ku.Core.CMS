...
{
    public class AuthAuthorizationRequirement : IAuthorizationRequirement
    {

    }

    public class AuthAuthorizationHandler : AttributeAuthorizationHandler<AuthAuthorizationRequirement, AuthAttribute>
    {
        private IFunctionService service;

        public AuthAuthorizationHandler(IFunctionService _service)
        {
