...
namespace Ku.Core.CMS.Web.Backend.Pages.Content.Advertisement.AdvertisementBoard
{
    /// <summary>
    /// 广告牌 编辑页面
    /// </summary>
    ...
    public class EditModel : BasePage
    {
        ...
        public EditModel(IAdvertisementBoardService service)
        {
            this._service = service;
        }

        [BindProperty]
        public AdvertisementBoardDto Dto { set; get; }
